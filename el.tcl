...
set namfile [open el.nam w]
$ns namtrace-all $namfile

set tracefile [open el.tr w]
...
proc finish {} {
	...
	close $tracefile
	exec nam el.nam &
	exec awk -f el.awk cwnd1.tr > tcp1 &
	exec awk -f el.awk cwnd2.tr > tcp2 &
	exit 0
}
...
$tcp1 attach $tfile1
$tcp1 trace cwnd_set tcp2 [new Agent/TCP/Reno]
